...
Route::group(['middleware' => ['web','auth', 'language']], function () {
    ...
    Route::post('/admin/articles/categories/description/store/{article_category_id}', 'Redicon\CMS_Articles\App\Http\Controllers\Admin\ArticlesCategoriesController@descriptionStore')->name('admin.articles.categories.description.store');
    Route::get('/admin/articles/categories/description/create/{article_category_id}/{lang?}', 'Redicon\CMS_Articles\App\Http\Controllers\Admin\ArticlesCategoriesController@descriptionCreate')->name('admin.articles.categories.description.create');
    ...
    Route::get('/admin/articles/categories/description/delete/{article_cat_description_id}', 'Redicon\CMS_Articles\App\Http\Controllers\Admin\ArticlesCategoriesController@descriptionDelete')->name('admin.articles.categories.description.delete');
